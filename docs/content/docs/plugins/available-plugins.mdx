...
Wallet plugins discover [Wallet Standard](https://github.com/wallet-standard/wallet-standard) wallets in the browser, manage the connection lifecycle on a `client.wallet` namespace, and can install the connected wallet's signer as the `payer`, the `identity`, or both. See [Setting up signers](/docs/guides/setting-up-signers#use-a-browser-wallet) for the framework-agnostic API and [React — Wallet hooks](/docs/guides/react/wallet) for the React bindings.

| Maintainer                    | Package                                                                                | Plugins               | Description                                                                              |
| ----------------------------- | -------------------------------------------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------------- |
| [Anza](https://www.anza.xyz/) | [`@solana/kit-plugin-wallet`](https://www.npmjs.com/package/@solana/kit-plugin-wallet) | `walletSigner`        | Sync the connected wallet's signer to both `payer` and `identity`. Most dApps want this. |
| [Anza](https://www.anza.xyz/) | [`@solana/kit-plugin-wallet`](https://www.npmjs.com/package/@solana/kit-plugin-wallet) | `walletPayer`         | Sync the connected wallet's signer to `payer` only.                                      |
| [Anza](https://www.anza.xyz/) | [`@solana/kit-plugin-wallet`](https://www.npmjs.com/package/@solana/kit-plugin-wallet) | `walletIdentity`      | Sync the connected wallet's signer to `identity` only.                                   |
| [Anza](https://www.anza.xyz/) | [`@solana/kit-plugin-wallet`](https://www.npmjs.com/package/@solana/kit-plugin-wallet) | `walletWithoutSigner` | Expose wallet state and actions without touching `payer` or `identity`.                  |
