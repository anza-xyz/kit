...
const client = {} as Client;
const transactionMessage = null as unknown as BaseTransactionMessage & ITransactionMessageWithFeePayer;
// ---cut-before---
...
import {
  ...
  ITransactionMessageWithFeePayer, // [!code ++]
  // ...
} from "@solana/kit";

export type Client = {
  estimateAndSetComputeUnitLimit: <T extends BaseTransactionMessage & ITransactionMessageWithFeePayer>(
...
export async function createClient(): Promise<Client> {
  if (!client) {
    ...
    const estimateAndSetComputeUnitLimit = async <T extends BaseTransactionMessage & ITransactionMessageWithFeePayer>( // [!code ++]
      transactionMessage: T, // [!code ++]
    ) => {
      // [!code ++]
...
```ts twoslash
import { BaseTransactionMessage, ITransactionMessageWithFeePayer } from "@solana/kit";
const transactionMessage = null as unknown as BaseTransactionMessage & ITransactionMessageWithFeePayer;
// ---cut-before---
