...
test('the dev server serves the app and optimized React dependency', { timeout: 60_000 }, async t => {
    ...
    async function checkModules() {
        ...
        // Vite's optimized-dep cache path; if this 404s after a Vite bump, check whether
        // the cache dir or flat id naming changed before assuming pre-bundling broke.
