...
describe('useSubscription', () => {
    ...
    it('unwraps `SolanaRpcResponse` envelopes: `data` is the inner value and `slot` is lifted', async () => {
        ...
        expect(result.current.data).toStrictEqual({ lamports: 5n });
        expect(result.current.slot).toBe(99n);
    });
