...
function getSignaturesToEncode(signaturesMap: OffchainMessageSignaturesMap): SignatureBytes[] {
...
export function getSignaturesEncoder(): VariableSizeEncoder<OffchainMessageSignaturesMap> {
