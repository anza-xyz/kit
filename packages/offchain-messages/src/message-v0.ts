...
export type BaseOffchainMessageV0 = Omit<
    ...
    'messageFormat' | 'messageLength' | 'requiredSigners'
>;
...
export type OffchainMessageWithRequiredSignerAddresses = Pick<OffchainMessagePreambleV0, 'requiredSigners'>;
...
export type BaseOffchainMessage = Omit<
    OffchainMessagePreambleV0,
    'messageFormat' | 'messageLength' | 'requiredSigners'
>;
