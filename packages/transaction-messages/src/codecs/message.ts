...
import { getLifetimeTokenDecoder, getOptionalLifetimeTokenEncoder } from './legacy/lifetime-token';
import { getAddressTableLookupDecoder, getAddressTableLookupEncoder } from './v0/address-table-lookup';
import { getTransactionVersionDecoder, getTransactionVersionEncoder } from './v0/transaction-version';
...
function getPreludeStructEncoderTuple() {
    return [
        ...
        ['lifetimeToken', getOptionalLifetimeTokenEncoder()],
