...
export const SolanaErrorMessages: Readonly<{
    ...
    [SOLANA_ERROR__INSTRUCTION_PLANS__MISSING_INSTRUCTIONS_IN_INSTRUCTION_PLAN]:
        'No instructions were found in the provided instruction plan.',
    [SOLANA_ERROR__INSTRUCTION_PLANS__MESSAGE_CANNOT_ACCOMMODATE_PLAN]:
        'The provided message has insufficient capacity to accommodate the next instruction(s) in this plan.',
