...
export const SolanaErrorMessages: Readonly<{
    ...
    [SOLANA_ERROR__TRANSACTION__EXPECTED_LEGACY_TRANSACTION_MESSAGE]:
        'Transaction message is not a legacy version transaction message',
    [SOLANA_ERROR__TRANSACTION__EXPECTED_NONCE_LIFETIME]: 'Transaction is not a durable nonce transaction',
    [SOLANA_ERROR__TRANSACTION__EXPECTED_V0_TRANSACTION_MESSAGE]: 'Transaction is not a V0 transaction message',
    [SOLANA_ERROR__TRANSACTION__FAILED_TO_DECOMPILE_ADDRESS_LOOKUP_TABLE_CONTENTS_MISSING]:
