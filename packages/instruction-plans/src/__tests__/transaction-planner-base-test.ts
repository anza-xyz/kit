...
import { SOLANA_ERROR__INSTRUCTION_PLANS__MESSAGE_FACTORY_CANNOT_ACCOMMODATE_PLAN, SolanaError } from '@solana/errors';
...
describe('createBaseTransactionPlanner', () => {
    describe('single scenarios', () => {
        ...
        it('fail if a single instruction is too large', async () => {
            ...
            await expect(planner(instructionPlan)).rejects.toThrow(
                new SolanaError(SOLANA_ERROR__INSTRUCTION_PLANS__MESSAGE_FACTORY_CANNOT_ACCOMMODATE_PLAN, {
                    instructionPlan,
    ...
    describe('freezability', () => {
        it('freezes single transaction plans', async () => {
            ...
            const planner = createBaseTransactionPlanner({ createTransactionMessage: createMockTransactionMessage });
