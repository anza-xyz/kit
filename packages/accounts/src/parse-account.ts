...
type JsonParsedAccountData<TData extends object> = TData & { program?: string; type?: string };
...
export function parseJsonRpcAccount<TData extends object, TAddress extends string = string>(
    ...
    const data = { ...info, program: rpcAccount.data.program, type: parsed.type } as JsonParsedAccountData<TData>;
    return Object.freeze({ ...parseBaseAccount(rpcAccount), address, data, exists: true });
}
