...

{
    ...
    fetchJsonParsedAccount<MockData, '1111'>(rpc, address) satisfies Promise<
        MaybeAccount<MockData & { program?: string; type?: string }, '1111'> | MaybeEncodedAccount<'1111'>
    >;
...

{
    ...
    fetchJsonParsedAccounts<MockData[]>(rpc, [] as Address[]) satisfies Promise<
        (MaybeAccount<MockData & { program?: string; type?: string }> | MaybeEncodedAccount)[]
    >;
    fetchJsonParsedAccounts<MockData[], ['1111', '2222']>(rpc, [address, otherAddress]) satisfies Promise<
        [
            MaybeAccount<MockData & { program?: string; type?: string }, '1111'> | MaybeEncodedAccount<'1111'>,
            MaybeAccount<MockData & { program?: string; type?: string }, '2222'> | MaybeEncodedAccount<'2222'>,
        ]
    >;
    fetchJsonParsedAccounts<[MockData, OtherMockData]>(rpc, [address, otherAddress]) satisfies Promise<
        [
            MaybeAccount<MockData & { program?: string; type?: string }> | MaybeEncodedAccount,
            MaybeAccount<OtherMockData & { program?: string; type?: string }> | MaybeEncodedAccount,
        ]
    >;
    fetchJsonParsedAccounts<[MockData, OtherMockData], ['1111', '2222']>(rpc, [
        ...
        [
            MaybeAccount<MockData & { program?: string; type?: string }, '1111'> | MaybeEncodedAccount<'1111'>,
            MaybeAccount<OtherMockData & { program?: string; type?: string }, '2222'> | MaybeEncodedAccount<'2222'>,
        ]
    >;
}
