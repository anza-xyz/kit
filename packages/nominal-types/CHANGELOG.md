...
- [#576](https://github.com/anza-xyz/kit/pull/576) [`a360141`](https://github.com/anza-xyz/kit/commit/a3601410e8c8b1e4077d5e5daf942bc3a92363fc) Thanks [@nickfrosty](https://github.com/nickfrosty)! - Added `AffinePoint`; a nominal type that you can use to tag a value as representing an affine point over some field that is either valid or invalid from the perspective of some curve. Typically this will be used to tag an address as either on or off curve.
